...
<div class="container">
            <div class="box">
                <h4 class="display-4 text-center">Publicidad registrada(All time)</h4><hr>
                ...
                <table class="table table-striped">
                   ...
                   ?>
                        ...
                        ?>
                            <br>
                           <br>
                            <a href="editar_publicidad.php?id=<?=$rows['id_publicidad']?>" 
                               class="btn btn-warning">Editar datos</a><br><br>
                            
                            <a href="php/eliminar.php?id=<?=$rows['id_publicidad']?>" 
