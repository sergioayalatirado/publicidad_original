...
// echo "<pre>";
// var_dump($verificar_horario);
// echo "</pre>";

if($resultado_rows > 0){
  
    // $consulta1 = mysqli_fetch_assoc($resultado1);
    // header("Location: ../cargar_publicidad.php?error=Se encontro que existen ".$resultado_rows." publicidades entre este rango de hrs.");
    // $lista = "<ul>";
    ...
    //     $lista.="<li>$titulo_publicidad $fecha_hora_inicio $fecha_hora_inicial</li>";
    // }
    // $lista = "</ul>";
    // echo $lista;
